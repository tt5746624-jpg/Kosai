...
# --- Configuration ---
TOKEN = '8800445260:AAESE7hmzJCmvG2zrxf5q50tYZIoRYjXax8' # Replace with your actual token
OWNER_ID = 6265842075 # Replace with your Owner ID
ADMIN_ID = 6182661436 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@kosaich1' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/token68834_ok' # Replace with your update channel link
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Contact Owner', url=f'https://t.me/{YOUR_USERNAME.replace("@kosaich1", "")}')
    ]
